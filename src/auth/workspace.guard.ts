...
export class WorkspaceGuard implements CanActivate {
  ...
  async canActivate(
    ...
    const rolePerm = rolePermissions.find((rp) => rp.permission.code === PermissionCodes.workspaceManage);
    ...
    const relation = await this.workspaceOvverideRepo.findOne({ where: { user: { id: userId }, workspace: { id: workspaceId } } });
